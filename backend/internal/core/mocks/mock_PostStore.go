...
func (_m *MockPostStore) GetPostsForModeration(ctx context.Context) ([]core.Post, error) {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *MockPostStore_Expecter) GetPostsForModeration(ctx interface{}) *MockPostStore_GetPostsForModeration_Call {
	return &MockPostStore_GetPostsForModeration_Call{Call: _e.mock.On("GetPostsForModeration", ctx)}
}

func (_c *MockPostStore_GetPostsForModeration_Call) Run(run func(ctx context.Context)) *MockPostStore_GetPostsForModeration_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPostStore_GetPostsForModeration_Call) Return(_a0 []core.Post, _a1 error) *MockPostStore_GetPostsForModeration_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPostStore_GetPostsForModeration_Call) RunAndReturn(run func(context.Context) ([]core.Post, error)) *MockPostStore_GetPostsForModeration_Call {
	_c.Call.Return(run)
	return _c
}
