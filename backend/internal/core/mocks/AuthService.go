...
// AuthorizeTelegram provides a mock function with given fields: ctx, telegramUserID
func (_m *AuthService) AuthorizeTelegram(ctx context.Context, telegramUserID int) (*string, *string, error) {
...
// GetTelegramAuthBotURL provides a mock function with given fields:
func (_m *AuthService) GetTelegramAuthBotURL() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetTelegramAuthBotURL")
	}
