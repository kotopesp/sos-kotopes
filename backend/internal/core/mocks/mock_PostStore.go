...
func (_m *MockPostStore) GetAllPosts(ctx context.Context, userID int, params core.GetAllPostsParams) ([]core.Post, int, error) {
...
func (_e *MockPostStore_Expecter) GetAllPosts(ctx interface{}, userID interface{}, params interface{}) *MockPostStore_GetAllPosts_Call {
	return &MockPostStore_GetAllPosts_Call{Call: _e.mock.On("GetAllPosts", ctx, userID, params)}
}

func (_c *MockPostStore_GetAllPosts_Call) Run(run func(ctx context.Context, userID int, params core.GetAllPostsParams)) *MockPostStore_GetAllPosts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPostStore_GetAllPosts_Call) RunAndReturn(run func(context.Context, int, core.GetAllPostsParams) ([]core.Post, int, error)) *MockPostStore_GetAllPosts_Call {
	_c.Call.Return(run)
	return _c
}

// GetPostByID provides a mock function with given fields: ctx, postID, userID
func (_m *MockPostStore) GetPostByID(ctx context.Context, postID int, userID int) (core.Post, error) {
	...
	var r0 core.Post
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int) (core.Post, error)); ok {
...
//   - postID int
//   - userID int
func (_e *MockPostStore_Expecter) GetPostByID(ctx interface{}, postID interface{}, userID interface{}) *MockPostStore_GetPostByID_Call {
	return &MockPostStore_GetPostByID_Call{Call: _e.mock.On("GetPostByID", ctx, postID, userID)}
}

func (_c *MockPostStore_GetPostByID_Call) Run(run func(ctx context.Context, postID int, userID int)) *MockPostStore_GetPostByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPostStore_GetPostByID_Call) RunAndReturn(run func(context.Context, int, int) (core.Post, error)) *MockPostStore_GetPostByID_Call {
	_c.Call.Return(run)
	return _c
}
