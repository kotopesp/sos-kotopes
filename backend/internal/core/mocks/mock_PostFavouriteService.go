...
func (_m *MockPostFavouriteService) DeleteFromFavourites(_a0 context.Context, _a1 core.PostFavourite) error {
...
func (_e *MockPostFavouriteService_Expecter) DeleteFromFavourites(_a0 interface{}, _a1 interface{}) *MockPostFavouriteService_DeleteFromFavourites_Call {
	return &MockPostFavouriteService_DeleteFromFavourites_Call{Call: _e.mock.On("DeleteFromFavourites", _a0, _a1)}
}

func (_c *MockPostFavouriteService_DeleteFromFavourites_Call) Run(run func(_a0 context.Context, _a1 core.PostFavourite)) *MockPostFavouriteService_DeleteFromFavourites_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(core.PostFavourite))
	})
	return _c
